...
public class BluetoothLeService extends Service {
    ...
    public final static String EXTRA_DATA_FROM_DEVICE = "com.example.bluetooth.le.EXTRA_DATA_FROM_DEVICE";
    ...
    private void broadcastUpdate(final String action,
        ...
        if (characteristic.getUuid().equals(UUID.fromString(LedButtonGattAttributes.button_char_uuid))){
            byte[] recvData = characteristic.getValue();
            intent.putExtra(EXTRA_DATA_FROM_DEVICE, String.valueOf(recvData[0]));
            sendBroadcast(intent);
