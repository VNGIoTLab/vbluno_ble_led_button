...
public class DeviceControlActivity extends Activity {
    ...
    private TextView lblLed;
    private ToggleButton tgbLed;
    private TextView lblButton;
    private TextView lblButtonValue;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Log.d(TAG, "Process data from device");
    ...
    private void enableControl(boolean en) {
        ...
        lblLed.setEnabled(en);
        tgbLed.setEnabled(en);
        lblButton.setEnabled(en);
        lblButtonValue.setEnabled(en);

        if (en == true) {
            if(mBluetoothLeService != null) {
                mBluetoothLeService.notifyCustomCharacteristic(LedButtonGattAttributes.led_button_service_uuid,
                                                               LedButtonGattAttributes.button_char_uuid,
                                                               true);
            }
        }
        else {
            tgbLed.setChecked(false);
            lblButtonValue.setText("");
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.led_button_action);
        ...
        //UI control
        lblLed = (TextView) findViewById(R.id.lblControlLed);
        tgbLed = (ToggleButton) findViewById(R.id.tgbLed);
        lblButton = (TextView) findViewById(R.id.lblButton);
        lblButtonValue = (TextView) findViewById(R.id.lblButtonValue);
        enableControl(false);
    }
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            currentServiceData.put(
                    LIST_NAME, LedButtonGattAttributes.lookup(uuid, unknownServiceString));
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                currentCharaData.put(
                        LIST_NAME, LedButtonGattAttributes.lookup(uuid, unknownCharaString));
